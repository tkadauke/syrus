  ...
  namespace :api do
    namespace :v1 do
      namespace :app do
        ...
        post "bug_reports/chat", to: "bug_reports#chat"
        ...
        post "jobs/:job_id/diff_review_comments/:id/reply", to: "diff_review_comments#reply", constraints: { job_id: /[a-zA-Z0-9_-]+/, id: /\d+/ }
        ...
        post "chats/:id/coding_handoff", to: "chats#create_coding_handoff", constraints: { id: /\d+/ }
        ...
        namespace :admin do
          ...
          resources :retention_archives, only: %i[ index ] do
            member do
              get :download
            end
          end
