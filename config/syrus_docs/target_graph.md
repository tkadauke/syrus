...
desktop unit tests still use the root Vitest dependency set, and the root
Go-workspace backstop still covers release/desktop packaging paths that bundle
the CLI.
