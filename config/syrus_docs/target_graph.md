...
selected. Broad sweeps bypass the "already graded this SHA" shortcut,
per-target health reuse, and full-plan grader conclusion reuse while still
honoring the normal one-active-main-grader-per-repository guard.
