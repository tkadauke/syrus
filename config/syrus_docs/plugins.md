...
when the checkout looks like a Rails app, it prepares the test database before
running those focused specs. It also contributes rich default grade candidates
through `:grade_detector`: full RSpec for landing/CI, focused RSpec for review,
...
numeric form of the same comparison `relation` makes: a
