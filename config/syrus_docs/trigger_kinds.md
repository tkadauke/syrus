...
already has an affected-target health result; they also bypass per-target
health reuse and full-plan grader conclusion reuse. This gives operators a
scheduled full-closure backstop before release windows or after graph changes.
