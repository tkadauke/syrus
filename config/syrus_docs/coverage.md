...
Coverage artifacts are normally produced by the first implementation or feedback grader pass. Typed framework graders can own coverage toggles and artifact paths directly; custom `run:` graders should produce the configured coverage artifact themselves.
