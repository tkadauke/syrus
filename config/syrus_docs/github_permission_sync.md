...
enforces or auto-corrects anything on either side. Part of the
access-control work: groundwork for a future where self-hosted git removes GitHub as a required
