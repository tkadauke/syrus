...
| `approve` | `[open, implemented, landing_failed] → approved` | before: assign_approval_metadata | JobsController, HomeController bulk, AutoApprovalRule, PollMergeStateJob, PollPullRequestJob |
