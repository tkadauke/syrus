...
| `app/controllers/api/v1/app/terminal_sessions_controller.rb` | per-user/private | Terminal sessions and recent Workflow workspace choices are listed, created, and killed only for the signed-in user. |
