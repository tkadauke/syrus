class Step
  module Kind
    ...
    #   :external_pr_merge → reconcile_external_pr_merge
    ...
    BUILT_IN_ENTRIES = [
      ...
      Entry.new(kind: "format",             handler: "Format",             label: "Format",                     style: "bg-lime-100 text-lime-700",   agentic: false,
                fail_policy: :advance,
                repair_semantics: :deterministic_idempotent),
      Entry.new(kind: "generate",           handler: "Generate",           label: "Generate",                   style: "bg-lime-200 text-lime-800",   agentic: false,
                fail_policy: :advance,
                repair_semantics: :deterministic_idempotent),
      ...
      Entry.new(kind: "force_push",         handler: "ForcePush",          label: "Force-push",                 style: "bg-amber-100 text-amber-700", agentic: false,
                repair_semantics: :publication),
      Entry.new(kind: "promotion_assemble", handler: "PromotionAssemble",  label: "Assemble promotion",         style: "bg-fuchsia-100 text-fuchsia-700", agentic: false,
                repair_semantics: :deterministic_idempotent),
      Entry.new(kind: "promotion_repair",   handler: "PromotionRepair",    label: "Promotion repair",           style: "bg-fuchsia-100 text-fuchsia-700", agentic: true),
      Entry.new(kind: "promotion_publish",  handler: "PromotionPublish",   label: "Publish promotion",          style: "bg-fuchsia-100 text-fuchsia-700", agentic: false,
                repair_semantics: :publication),
      Entry.new(kind: "hotfix_sync_assemble", handler: "HotfixSyncAssemble", label: "Assemble hotfix sync",     style: "bg-fuchsia-200 text-fuchsia-800", agentic: false,
                repair_semantics: :deterministic_idempotent),
      ...
      Entry.new(kind: "speculative_landing_build", handler: "SpeculativeLandingBuild", label: "Build speculative landing", style: "bg-emerald-100 text-emerald-700", agentic: false,
                repair_semantics: :deterministic_idempotent),
      Entry.new(kind: "speculative_merge_train_build", handler: "SpeculativeMergeTrainBuild", label: "Build speculative train", style: "bg-emerald-100 text-emerald-800", agentic: false,
                repair_semantics: :deterministic_idempotent),
      Entry.new(kind: "builder_fanout",     handler: "BuilderFanout",      label: "Build hot targets",          style: "bg-emerald-100 text-emerald-700", agentic: false,
                fail_policy: :advance,
                repair_semantics: :deterministic_idempotent),
      ...
      Entry.new(kind: "external_pr_merge",  handler: "ExternalPrMerge",    label: "Merge external PR",          style: "bg-green-100 text-green-700", agentic: false,
                repair_semantics: :publication,
                reconcile_strategy: :external_pr_merge),
      ...
      Entry.new(kind: "merge_train_rebase", handler: "MergeTrainRebase",   label: "Rebase integration branch", style: "bg-teal-100 text-teal-700",   agentic: false,
                repair_semantics: :publication),
      Entry.new(kind: "merge_train_agent_rebase", handler: "MergeTrainAgentRebase", label: "Resolve train rebase", style: "bg-teal-100 text-teal-700", agentic: true),
      ...
      Entry.new(kind: "coverage_pr_comment", handler: "CoveragePrComment", label: "Post coverage comment",     style: "bg-yellow-100 text-yellow-700", agentic: false,
                repair_semantics: :publication),
      Entry.new(kind: "dependency_audit",   handler: "DependencyAudit",   label: "Dependency audit",           style: "bg-orange-100 text-orange-700", agentic: false,
                fail_policy: :advance,
                repair_semantics: :deterministic_idempotent),
