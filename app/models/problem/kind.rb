class Problem
  ...
  module Kind
    ...
    BUILT_IN_ENTRIES = [
      ...
      Entry.new(code: "worker_died_under_resource_pressure", scope: :run, retryable: true,
                default_remediation: :retry_step,
      ...
      Entry.new(code: "workspace_clone_timeout", scope: :run, retryable: true,
                default_remediation: :retry_step),
      Entry.new(code: "source_snapshot_metadata_invalid", scope: :workflow, retryable: true,
                default_remediation: :restart_workflow,
                label: "Source snapshot metadata invalid"),
