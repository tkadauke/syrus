  ...
  module Kind
    ...
    BUILT_IN_ENTRIES = [
      ...
      Entry.new(code: "workspace_clone_timeout", scope: :run, retryable: true,
                default_remediation: :retry_step),
      Entry.new(code: "source_snapshot_missing", scope: :run, retryable: true,
                default_remediation: :retry_step,
                label: "Source snapshot missing"),
      Entry.new(code: "source_snapshot_mismatch", scope: :run, retryable: true,
                default_remediation: :retry_step,
