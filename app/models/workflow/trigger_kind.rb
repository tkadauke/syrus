class Workflow
  module TriggerKind
    ...
    ENTRIES = [
      ...
      Entry.new(kind: "hotfix_sync",   template: "HotfixSync",  label: "Hotfix sync",             style: "bg-fuchsia-200 text-fuchsia-800", retry_label: "Retry hotfix sync step", feedback_kind: nil, runtime_role: "first_class"),
      ...
      Entry.new(kind: "visual_diff",   template: "VisualDiff",  label: "Before/after visual comparison", style: "bg-pink-50 text-pink-700", retry_label: "Retry failed step", feedback_kind: nil, runtime_role: "first_class"),
