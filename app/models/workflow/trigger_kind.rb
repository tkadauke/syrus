class Workflow
  module TriggerKind
    ...
    ENTRIES = [
      ...
      Entry.new(kind: "coding_handoff", template: "CodingHandoff", label: "Coding handoff",           style: "bg-amber-100 text-amber-700",     retry_label: "Retry graders",      feedback_kind: nil)
    ].freeze
