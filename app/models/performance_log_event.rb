  ...
  def self.compact_payload(attrs)
    {
      ...
      "provider_job_id" => attrs["provider_job_id"].to_s.safe_byteslice(0, 100).presence,
      "queue_name" => attrs["queue_name"].to_s.safe_byteslice(0, 100).presence,
      "priority" => attrs["priority"],
      "executions" => attrs["executions"],
      "arguments_count" => attrs["arguments_count"],
