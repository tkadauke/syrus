...
describe("tool result rendering", () => {
  ...
  it("opens an already-mounted group when a later result makes it prominent", () => {
    const pendingItem: ChatToolGroupItem = {
      type: "tool_group",
      tool: "Read",
    ...
    const { rerender } = render(<ToolGroup item={pendingItem} />)
