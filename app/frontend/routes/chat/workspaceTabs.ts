...
export function workspaceTabClass(active: boolean) {
  return `max-w-[33vw] shrink-0 truncate border-b-2 px-3 py-2 ${active ? "border-brand text-brand dark:border-brand-emphasis dark:text-brand-emphasis" : "border-transparent text-gray-600 hover:border-gray-300 hover:text-gray-900 dark:text-gray-400 dark:hover:border-gray-600 dark:hover:text-gray-100"}`
}
