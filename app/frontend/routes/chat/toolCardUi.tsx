...
import { CodeSurface, DescriptionList, Input, Pill, Surface, Text, ToolCard } from "../../components/ui"
...
export function Row({ label, value }: { label: string; value: string }) {
  return <DescriptionList.Item descriptionClassName="truncate font-mono text-xs" label={label}>{value}</DescriptionList.Item>
}
