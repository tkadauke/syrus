        ...
        <div className="flex min-h-0 flex-1">
          {treeCollapsed ? null : (
            <div className="shrink-0 overflow-y-auto py-1" style={{ width: `${treeWidth}px` }}>
              {fileTree.isPending ? (
                ...
                <p className="px-3 py-2 text-xs text-gray-500 dark:text-gray-400">{t("coding_checkout_preparing")}</p>
              ) : fileTree.isError ? (
          ...
          <div className="min-w-0 flex-1 overflow-y-auto">
            {!selectedFile ? (
              ...
              <p className="px-4 py-3 text-xs text-gray-500 dark:text-gray-400">{t("coding_checkout_preparing")}</p>
            ) : fileContent.isError ? (
