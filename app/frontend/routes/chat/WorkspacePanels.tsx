  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden">
      <div className="flex shrink-0 flex-wrap items-center gap-2 border-b border-gray-200 px-3 py-2 dark:border-gray-700">
        ...
        <Select aria-label={t("preview_image_background")} className="py-1 text-xs" fullWidth={false} value={background} onChange={(event) => setBackground(event.target.value as keyof typeof imageBackgroundClasses)}>
