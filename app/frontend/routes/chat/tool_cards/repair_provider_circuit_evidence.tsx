...
const repairProviderCircuitEvidenceToolCard: ToolCardRenderer = {
  toolName: "repair_provider_circuit_evidence",
  collapsedSummary,
  renderExpanded
}

export default repairProviderCircuitEvidenceToolCard
