...
const replacePrBranchWithWorkflowOutputToolCard: ToolCardRenderer = {
  toolName: "replace_pr_branch_with_workflow_output",
  collapsedSummary,
  renderExpanded
}

export default replacePrBranchWithWorkflowOutputToolCard
