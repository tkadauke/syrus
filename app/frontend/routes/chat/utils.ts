...
export function primaryButton() {
  return "flex h-11 items-center justify-center rounded border border-transparent bg-brand px-3 text-sm font-medium text-on-brand hover:opacity-90 focus-visible:ring-brand disabled:cursor-not-allowed disabled:opacity-60"
}
