...
export function AdminMaintenanceTasks() {
  const { t } = useT("admin")
  usePageTitle(t("page_title_maintenance_tasks"))
...
export function AdminMaintenanceTaskDetail() {
  ...
  if (detail.isPending) {
    return <AdminEventPageShell ariaLabel={t("maintenance_tasks.detail_aria")} eyebrow={t("section_label")} title={t("maintenance_tasks.detail_heading")}><AdminEventPanelMessage>{t("maintenance_tasks.detail_loading")}</AdminEventPanelMessage></AdminEventPageShell>
  }
  if (detail.isError) {
    return <AdminEventPageShell ariaLabel={t("maintenance_tasks.detail_aria")} eyebrow={t("section_label")} title={t("maintenance_tasks.detail_heading")}><AdminEventPanelMessage tone="error">{t("maintenance_tasks.detail_error_load")}</AdminEventPanelMessage></AdminEventPageShell>
  }
  ...
  return (
    ...
    >
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-text-primary">{t("maintenance_tasks.log_heading")}</h2>
