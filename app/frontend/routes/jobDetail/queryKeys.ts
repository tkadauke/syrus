...
export type JobTab = "summary" | "review" | "workflows" | "timeline" | "attachments" | "source" | "tests" | "artifacts"
...
export function tabFromLocation(pathname: string, search: string): JobTab {
  ...
  return value === "review" || value === "workflows" || value === "timeline" || value === "attachments" || value === "source" || value === "tests" || value === "artifacts" ? value : "summary"
}
