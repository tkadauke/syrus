...
export const CORE_ADMIN_NAV_ITEMS: readonly CoreAdminNavItem[] = [
  ...
  { id: "activity", labelKey: "nav_activity", to: "/admin/activity", paths: ["/admin/activity"], groupId: "operations", order: 60 },
  { id: "reconciler_activity", labelKey: "nav_reconciler_activity", to: "/admin/reconciler_activity", paths: ["/admin/reconciler_activity"], groupId: "operations", order: 70 },
