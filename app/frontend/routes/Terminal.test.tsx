...
function bootstrapPayload(overrides: Partial<BootstrapPayload> = {}): BootstrapPayload {
  return {
    ...
    team_user_count: 1,
    app: { revision: "dev", revision_url: null, version: null, built_at: null, bug_report_mode: null, report_issue_repo_slug: "tkadauke/syrus", mode: "advanced" as const, mode_configured: false },
    public: {
      first_signup: false,
      signups_open: false,
