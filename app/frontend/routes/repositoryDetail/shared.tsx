...
export function stateFilterClass(active: boolean) {
  return `rounded border px-3 py-1.5 text-sm font-medium ${active ? "border-brand bg-brand text-on-brand" : "border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-300 hover:border-brand/30 hover:bg-brand/10 hover:text-brand dark:hover:bg-gray-800 dark:hover:text-brand-emphasis"}`
}
