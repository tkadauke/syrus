...
describe("AdminPluginDetail", () => {
  ...
  it("renders a provided link shaped like the Terminal plugin primary surface", async () => {
    vi.spyOn(window, "fetch").mockResolvedValue(jsonResponse({
      name: "terminal",
      display_name: "Terminal",
      disable_blockers: [],
    ...
    expect(within(actions).getByRole("link", { name: "Open Terminal" })).toHaveAttribute("href", "/terminal")
  })
})
