...
function shapeBounds(shape: Shape, context?: CanvasRenderingContext2D): BoundingBox {
  switch (shape.kind) {
    case "rectangle":
    case "ellipse":
      return {
    ...
    case "text":
      return textBounds(shape, context)
  }
}
...
function ImageAnnotationModalContent({
  ...
  useOptionalShortcut("s", () => selectToolByShortcut("select"), {
    description: t("image_annotation.shortcut_select_tool", { tool: t("image_annotation.tool_select") }),
    group: shortcutGroup,
    groupOrder: 0
  })
  useOptionalShortcut("r", () => selectToolByShortcut("rectangle"), {
    description: t("image_annotation.shortcut_select_tool", { tool: t("image_annotation.tool_rectangle") }),
    group: shortcutGroup,
    groupOrder: 0
  })
  useOptionalShortcut("e", () => selectToolByShortcut("ellipse"), {
    description: t("image_annotation.shortcut_select_tool", { tool: t("image_annotation.tool_ellipse") }),
    group: shortcutGroup,
    groupOrder: 0
  })
  useOptionalShortcut("l", () => selectToolByShortcut("line"), {
    description: t("image_annotation.shortcut_select_tool", { tool: t("image_annotation.tool_line") }),
    group: shortcutGroup,
    groupOrder: 0
  })
  useOptionalShortcut("a", () => selectToolByShortcut("arrow"), {
    description: t("image_annotation.shortcut_select_tool", { tool: t("image_annotation.tool_arrow") }),
    group: shortcutGroup,
    groupOrder: 0
  })
  useOptionalShortcut("p", () => selectToolByShortcut("freehand"), {
    description: t("image_annotation.shortcut_select_tool", { tool: t("image_annotation.tool_freehand") }),
    group: shortcutGroup,
    groupOrder: 0
  })
  useOptionalShortcut("t", () => selectToolByShortcut("text"), {
    description: t("image_annotation.shortcut_select_tool", { tool: t("image_annotation.tool_text") }),
    group: shortcutGroup,
    groupOrder: 0
  })
  ...
  function handlePointerDown(event: ReactPointerEvent<HTMLCanvasElement>) {
    ...
    if (tool === "select") {
      ...
      for (let i = currentShapes.length - 1; i >= 0; i--) {
        ...
        if (hitTest(shape, point, context)) {
