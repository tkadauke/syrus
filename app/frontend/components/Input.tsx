...
export const Input = forwardRef<HTMLInputElement, InputProps>(function Input(
  ...
  return (
    <input
      ...
      className={`block h-[var(--control-height-md)] ${fullWidth ? "w-full" : "w-auto"} rounded-[var(--radius-control)] border border-[length:var(--border-width)] bg-surface px-3 text-[length:var(--text-body)] text-text-primary placeholder:text-text-secondary focus:outline-none focus:ring-1 disabled:cursor-not-allowed disabled:opacity-60 ${
