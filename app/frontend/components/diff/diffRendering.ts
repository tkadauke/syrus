...
export function parseUnifiedDiff(diff: string) {
  ...
  for (const rawLine of rawLines) {
    ...
    if (hunk) {
      ...
      lines.push({ kind: "hunk", oldLine: null, newLine: null, marker: "", code: rawLine, hunkOldStart, hunkOldLines, hunkNewStart, hunkNewLines })
      continue
    }
...
export function diffLine(kind: DiffLineKind, code: string, oldLine: number | null = null, newLine: number | null = null, marker = ""): DiffLine {
