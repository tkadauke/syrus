    ...
    <form className="space-y-5" onSubmit={submit}>
      <ol className="space-y-4 text-sm text-gray-700 dark:text-gray-300">
        ...
        <li>
          ...
          <p className="mt-1 text-gray-600 dark:text-gray-400">{t("github_token.step2_description")}</p>
...
function StatusLine({ tone, children }: { tone: "ok" | "warning" | "error"; children: React.ReactNode }) {
  const toneClass =
    tone === "ok" ? "text-green-700 dark:text-green-400" : tone === "warning" ? "text-amber-700 dark:text-amber-400" : "text-red-700 dark:text-red-400"
  return (
