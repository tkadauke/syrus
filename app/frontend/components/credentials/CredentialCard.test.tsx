...
describe("AgyCredentialCard", () => {
  ...
  it("explains that Antigravity uses the shared Gemini key when unset", () => {
    mockRoutes()
  ...
  it("tests Antigravity readiness with the agy credential alias when the shared key is saved", async () => {
    const fetchSpy = mockRoutes({
      test: () => jsonResponse({
        credential_test: {
          credential: "agy",
