...
export function PreviewPanel({
  ...
  const selectedPreviewProjectId = previewProjects.length > 1 ? selectedProjectId : previewProjects[0]?.id ?? selectedProjectId
      ...
      <div className="space-y-2">
        {previewProjects.length > 1 ? (
          <label className="block text-xs font-medium text-gray-600 dark:text-gray-300">
            ...
            <select
              className="w-full rounded border border-gray-300 bg-white px-2 py-1.5 text-sm text-gray-900 dark:border-gray-700 dark:bg-gray-950 dark:text-gray-100"
