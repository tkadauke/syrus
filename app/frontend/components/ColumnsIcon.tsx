// The standard "customize columns" icon used by every column-selector
// trigger button in the app (Dashboard's visible-columns/kanban-lane
// menus, Design Docs' column menu).
