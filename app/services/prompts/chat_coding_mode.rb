    ...
    def to_s
      <<~PROMPT
        ...
        **Your role:** You ARE the implement step for this session. Write code,
        ...
        Mode work to GitHub yourself; after operator confirmation Syrus captures
        the local checkout HEAD to a handoff branch. Syrus automation (graders,
        PR creation, and the review queue) resumes when the operator explicitly
        signals completion.
