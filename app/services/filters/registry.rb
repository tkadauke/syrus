module Filters
  ...
  SUBJECTS = {
    ...
    admin_invitation: Subject.new(
      name: :admin_invitation,
      model: Invitation,
      chips: {
        "email" => "Filters::Chips::AdminInvitations::Email",
        "inviter" => "Filters::Chips::AdminInvitations::Inviter",
        "expires_at" => "Filters::Chips::AdminInvitations::ExpiresAt",
        "created_at" => "Filters::Chips::AdminInvitations::CreatedAt"
      }
    ),
