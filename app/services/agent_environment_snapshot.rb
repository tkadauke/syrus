...
class AgentEnvironmentSnapshot
  ...
  CHAT_TOOL_GROUPS = {
    "repository context" => %w[attach_repository repo_info read_repo_document list_repo_documents create_repo_document delete_repo_document list_design_docs read_design_doc propose_design_doc comment_on_design_doc suggest_design_doc_change list_repository_test_insights read_test_insight read_job_test_results read_run_test_results compare_test_runtime],
