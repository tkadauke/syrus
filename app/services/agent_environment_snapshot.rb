...
class AgentEnvironmentSnapshot
  ...
  CHAT_TOOL_GROUPS = {
    "repository context" => %w[attach_repository repo_info read_repo_document list_repo_documents create_repo_document delete_repo_document list_design_docs read_design_doc propose_design_doc comment_on_design_doc suggest_design_doc_change list_repository_test_insights read_test_insight],
    "live Syrus state" => %w[list_chats list_jobs read_job explain_stuck_job read_pr list_open_issues list_open_prs cancel_job close_job_successfully retry_job rebase_job reopen_job poll_job_feedback run_visual_review check_job_mergeability delegate_issue pause_landing_queue resume_landing_queue read_epic],
