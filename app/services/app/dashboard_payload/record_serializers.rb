    ...
    module RecordSerializers
      ...
      def dashboard_job_json(job)
        ...
        payload = {
          ...
          landing_blocker_override_requested_by: owner_user_json(job.landing_blocker_override_requested_by_user),
          landing_blocker_override_used_at: job.landing_blocker_override_used_at&.iso8601,
      ...
      def dashboard_job_bulk_actions(job)
        ...
        {
          retry: writable && dashboard_job_can_retry?(job, active_runtime_work: active_runtime_work),
      ...
      def dashboard_job_can_retry?(job, active_runtime_work:)
        ...
        job.failed? || job.implemented? || job.landing_failure_reason.present? || job.latest_workflow&.failed? || false
      end
