  ...
  class JobDetailPayload
    ...
    def job_json
...

      {
        ...
        emergency_landed_at: iso8601(@job.emergency_landed_at),
        emergency_landed_by_user: user_reference_json(@job.emergency_landed_by_user),
    ...
    def coding_mode_takeover_blocked_reason(writable:)
      ...
      return JobCodingMode::Takeover::GITHUB_TOKEN_REQUIRED_MESSAGE if @job.repository.user.github_token.blank?
      return "#{@job.slug} has active workflow ownership and cannot be opened in Coding Mode yet." if coding_mode_takeover_incompatible_active_work?
    ...
    def coding_mode_takeover_incompatible_active_work?
