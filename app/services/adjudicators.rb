...
module Adjudicators
  ...
  # ladder includes it. KnownFlakyFailure sits with the other rung-0 checks,
  # ahead of it -- a free, deterministic answer must get its turn before an
  # expensive one is asked the same question.
  BUILT_INS = [
