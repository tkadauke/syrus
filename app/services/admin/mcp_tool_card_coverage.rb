module Admin
  class McpToolCardCoverage
    ...
    def priority_tool_rows
      @priority_tool_rows ||= aggregate_rows(priority_gap_usages, order_by: :priority)
    end
    ...
    def priority_gap_usages
      strong_names = strong_card_tool_names
      return usages if strong_names.empty?

      usages.where.not(normalized_tool_name: strong_names)
    end
