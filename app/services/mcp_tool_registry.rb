    ...
    def chat_entries
      [
        ...
        chat(Mcp::Tools::CompleteImplementStepTool,
          ...
          mutation: true),
        chat(Mcp::Tools::EmergencyLandTool, feature_flag: :emergency_land, required_roles: [ AgentRole::CHAT_CODING ], mutation: true),
        ...
        chat(Mcp::Tools::RuntimeStatusTool, feature_flag: :coding_mode, required_roles: [ AgentRole::CHAT_CODING ]),
        chat(Mcp::Tools::RuntimeBuildOrReloadTool, feature_flag: :coding_mode, required_roles: [ AgentRole::CHAT_CODING ], mutation: true),
        chat(Mcp::Tools::RuntimeLaunchTool, feature_flag: :coding_mode, required_roles: [ AgentRole::CHAT_CODING ], mutation: true),
        chat(Mcp::Tools::RuntimeSnapshotTool, feature_flag: :coding_mode, required_roles: [ AgentRole::CHAT_CODING ], mutation: true),
        chat(Mcp::Tools::RuntimeInspectTool, feature_flag: :coding_mode, required_roles: [ AgentRole::CHAT_CODING ]),
        chat(Mcp::Tools::RuntimeLogsTool, feature_flag: :coding_mode, required_roles: [ AgentRole::CHAT_CODING ]),
        chat(Mcp::Tools::RuntimeAcquireControlTool, feature_flag: :coding_mode, required_roles: [ AgentRole::CHAT_CODING ], mutation: true),
        chat(Mcp::Tools::RuntimeReleaseControlTool, feature_flag: :coding_mode, required_roles: [ AgentRole::CHAT_CODING ], mutation: true),
        chat(Mcp::Tools::RuntimeInputTool, feature_flag: :coding_mode, required_roles: [ AgentRole::CHAT_CODING ], mutation: true),
        chat(Mcp::Tools::RuntimeCaptureArtifactTool, feature_flag: :coding_mode, required_roles: [ AgentRole::CHAT_CODING ], mutation: true),
        chat(Mcp::Tools::RuntimeStopTool, feature_flag: :coding_mode, required_roles: [ AgentRole::CHAT_CODING ], mutation: true),
        ...
        chat(Mcp::Tools::AdminMcpToolUsageTool, admin_only: true),
        chat(Mcp::Tools::AdminMaintenanceTasksTool, admin_only: true, mutation: true),
        ...
        chat(Mcp::Tools::SendChatMessageTool, tier: :deferred, mutation: true),
