module Steps
  ...
  class Prepare < Base
    ...
    # plugins/build_cache/docs/syrus_docs/sccache_build_cache.md for what's
    # forwarded and why SCCACHE_BASEDIRS stays off by default.
    BASE_ENV_FORWARD = %w[
    ...
    # gem ordering, not a problem with the lockfile. It cost a production Job a landing
