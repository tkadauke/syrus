class Repositories::ChatPendingActionsController < ApplicationController
  ...
  def confirm
    if @pending_action.confirm!
      ...
      redirect_to repository_chats_path(@repository), alert: "Pending action was already handled."
    end
  end
