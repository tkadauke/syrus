    ...
    module App
      class JobPreviewController < BaseController
        ...
        def create
          ...
          unless project
            render_error("preview_project_required", I18n.t("api.job_preview.project_required"), status: :unprocessable_content)
            return
          end
        ...
        def preview_unavailable_message(selection)
          if selection.unavailable_reason == "no_affected_preview_project"
            I18n.t("api.job_preview.no_affected_preview_project")
          else
