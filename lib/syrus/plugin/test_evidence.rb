module Syrus
  module Plugin
    ...
    #   .flakiness_score(repository:, suite_name:, name:, workflow: nil)
    ...
    # flaky." Newer providers should use the optional `workflow:` to exclude
    # the current workflow's own attempts from its historical score.
    #
