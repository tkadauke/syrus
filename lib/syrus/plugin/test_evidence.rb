module Syrus
  module Plugin
    ...
    #   .flakiness_score(repository:, suite_name:, name:, excluding_workflow: nil)
    ...
    # flaky." When supported, `excluding_workflow:` omits the workflow being
    # adjudicated so a retry loop cannot inflate its own flaky reputation.
    #
