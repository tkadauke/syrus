...
RSpec.describe PollPullRequestJob, :ci_only do
  ...
  describe "ci_failure dispatch" do
    ...
    it "does not create a ci_failure workflow while the job is already landing" do
    ...
    it "still dispatches ci_failure for main branch repair jobs even while main is known-broken" do
      repair_job = Factories.job_record(
        user: user,
        repository: repository,
        kind: "direct",
