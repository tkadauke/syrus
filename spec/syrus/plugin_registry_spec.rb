...
RSpec.describe Syrus::PluginRegistry do
  ...
  describe "EXTENSION_POINTS" do
    ...
    it "includes all agreed extension points" do
      expect(described_class::EXTENSION_POINTS).to include(
        :agent_provider, :mcp_tool_set, :input_source,
        :prompt_injector, :artifact_renderer,
        :test_result_parser, :coverage_analyzer, :preview_provider
      )
    end
  end
end
