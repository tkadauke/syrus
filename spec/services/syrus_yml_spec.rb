  ...
  describe "targets: key" do
    ...
    it "parses explicit targets and dependencies" do
      ...
      expect(config.targets).to eq([
        described_class::TargetConfig.new(name: "renderer", kind: "library", command: nil, sources: [ "src/**/*.ts" ], deps: [], timeout_minutes: nil, metadata: {}),
        described_class::TargetConfig.new(name: "typecheck", kind: "grader", command: "npm run typecheck", sources: [], deps: [ ":renderer" ], timeout_minutes: nil, metadata: {})
      ])
    end
