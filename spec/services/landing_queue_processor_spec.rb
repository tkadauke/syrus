...
RSpec.describe LandingQueueProcessor, :ci_only do
  ...
  it "skips an approved Job whose repository is already landing" do
    ...
    landing.start_landing!
    landing.save!
    WorkUnits::Launcher.instantiate(kind: "auto_merge", job: landing).work_unit.update!(state: "running")
  ...
  describe "delivery-track-aware landing (EPIC-268)" do
    ...
    describe "track-scoped landing locks" do
      ...
      it "serializes two hotfix-track Jobs landing to the same branch" do
        ...
        landing_hotfix.save!
        WorkUnits::Launcher.instantiate(kind: "auto_merge", job: landing_hotfix).work_unit.update!(state: "running")
