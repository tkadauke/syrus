...
RSpec.describe ChatChannel::Telegram do
  ...
  it "reads the bot token and webhook secret from ENV before AppSetting" do
    AppSetting.current.update!(
      telegram_bot_token: "setting-token",
      telegram_webhook_secret: "setting-secret"
    )
    old_token = ENV["TELEGRAM_BOT_TOKEN"]
    old_secret = ENV["TELEGRAM_WEBHOOK_SECRET"]
    ENV["TELEGRAM_BOT_TOKEN"] = "env-token"
    ENV["TELEGRAM_WEBHOOK_SECRET"] = "env-secret"
