  ...
  describe ".tool_definitions" do
    ...
    it "includes all built-in workflow tool names" do
      ...
      expect(names).to contain_exactly(
        ...
        "submit_summary", "submit_test_plan", "submit_artifact", "run_target_prepare", "submit_visual_artifact", "list_artifacts", "read_artifact", "submit_job_metadata", "submit_adversarial_review"
      )
    end
