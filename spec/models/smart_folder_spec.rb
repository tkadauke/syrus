...
RSpec.describe SmartFolder do
  it "creates the built-in folders as system-owned rows" do
    # 17 Job built-ins (13 + 4 delivery) + 9 Epic + 4 Workflow + 4 Admin User
    # + 3 Spawned Process + 11 Admin Queue = 48.
    expect { described_class.ensure_builtins! }.to change(described_class, :count).by(48)
