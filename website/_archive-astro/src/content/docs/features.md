...
- **Credentials** stores GitHub PAT fallback, Claude credentials, Codex credentials, structured OpenCode backend settings, and the admin API token panel for admins.
