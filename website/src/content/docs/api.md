...
authenticated user. Chat results are grouped by conversation: the best
matching message is the representative result, and grouped chat rows may
include `grouped_matches`, `total_match_count`, and `has_more_matches` for
inline expansion.
