...
// Documented exceptions called out in the epic scan: the first two render
// user-facing color *pickers*, where "blue" is a literal color choice being
// offered to the user; syntaxHighlight.tsx renders a fixed multi-hue code
// palette, not app chrome that should inherit the user's selected theme.
const EXEMPT_FILES = [
