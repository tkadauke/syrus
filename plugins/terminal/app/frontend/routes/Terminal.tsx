                        ...
                        {group.items.map((workspace) => (
                          ...
                          >
                            ...
                            <span className="block truncate text-xs text-gray-400">
                              {workspace.disabled_reason || workspace.secondary_text || workspace.working_directory}
                            </span>
                            {workspace.secondary_text ? (
                              <span className="block truncate font-mono text-[11px] text-gray-500">{workspace.working_directory}</span>
                            ) : null}
                          </button>
                        ))}
                      </section>
  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col">
      ...
      <div className="flex shrink-0 items-center gap-3 border-t border-gray-800 bg-gray-900 px-3 py-2 text-xs text-gray-300">
        <span className={connected ? "text-emerald-300" : "text-gray-500"}>
