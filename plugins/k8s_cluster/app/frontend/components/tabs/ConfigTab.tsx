...
import { fetchKubernetesConfigMaps, fetchKubernetesSecrets } from "../../api/kubernetesResources"
...
function ExpandableKeyRow({
  ...
  return (
    <>
      <DataTable.Row key={`${namespace}/${name}`}>
        <DataTable.Cell className="font-medium">{name}</DataTable.Cell>
