...
module VideoWalkthroughs
  ...
  class AnalyzeWalkthroughSegmentTool < MCP::Tool
    ...
    class << self
      # Test seam mirroring VideoWalkthroughs::AnalysisJob.client_factory: specs
      ...
      def call(server_context:, walkthrough_id: nil, start: nil, focus: nil, **rest)
        ...
        start_seconds = VideoWalkthroughs::Gemini::FrameExtractor.parse_timestamp(start)
        end_seconds = VideoWalkthroughs::Gemini::FrameExtractor.parse_timestamp(finish)
      ...
      rescue VideoWalkthroughs::Gemini::Client::AuthError => e
      ...
      rescue VideoWalkthroughs::Gemini::Client::Error => e
      ...
      def run_segment(client, file_uri, mime_type, start_seconds, end_seconds, focus, media_resolution:)
        client.analyze_segment(
          ...
          prompt: VideoWalkthroughs::Prompts::Segment.new(
            focus: focus, clock_range: clock_range(start_seconds, end_seconds)
          ).to_s,
          response_schema: VideoWalkthroughs::Prompts::Segment::RESPONSE_SCHEMA,
