...
RSpec.describe "Test Insight MCP tools" do
  ...
  describe TestInsights::Tools::ListRepositoryTestInsightsTool do
  ...
  describe TestInsights::Tools::ReadTestInsightTool do
    it "reads recent history, duration points, references, and bounded failure snippets" do
      ...
      expect(payload.dig(:test, :recent_failure_count)).to eq(1)
  ...
  describe TestInsights::Tools::ReadJobTestResultsTool do
  ...
  describe TestInsights::Tools::ReadRunTestResultsTool do
  ...
  describe TestInsights::Tools::CompareTestRuntimeTool do
