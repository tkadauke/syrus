    ...
    <CardShell>
      ...
      {panel.entryFile || panel.fileCount != null ? (
        <DescriptionList.Root className="sm:grid-cols-2" density="compact">
          {panel.entryFile ? <DescriptionList.Item descriptionClassName="truncate font-mono text-xs" label="Entry file">{panel.entryFile}</DescriptionList.Item> : null}
          {panel.fileCount != null ? <DescriptionList.Item descriptionClassName="truncate font-mono text-xs" label="Files">{panel.fileCount}</DescriptionList.Item> : null}
