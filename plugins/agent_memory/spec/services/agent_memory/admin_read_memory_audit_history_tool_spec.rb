...
RSpec.describe AgentMemory::Tools::AdminReadMemoryAuditHistoryTool do
  ...
  it "rejects non-admin chat contexts" do
    memory = AgentMemory::Entry.create!(user: owner, kind: "feedback", scope: "global", content: "Hi.")
  ...
  it "returns the full audit trail for a created-then-updated memory, oldest first" do
    memory = AgentMemory::Entry.create!(user: owner, kind: "feedback", scope: "global", content: "Original.")
  ...
  it "includes soft-deleted memories and marks the response deleted" do
    memory = AgentMemory::Entry.create!(user: owner, kind: "feedback", scope: "global", content: "Stale.")
