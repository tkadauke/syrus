...
RSpec.describe AgentMemory::Tools::ReadMemoryTool do
  ...
  describe ".call from a chat session context" do
    ...
    it "reads an owned memory" do
      memory = AgentMemory::Entry.create!(user: chat_user, kind: "feedback", scope: "global", content: "Nice.")
    ...
    it "reads published memories from other users in an attached repository" do
      ...
      published  = AgentMemory::Entry.create!(user: other_user, kind: "reference", scope: "repository",
    ...
    it "rejects unpublished memories owned by other users" do
      other_user = Factories.user
      private_m  = AgentMemory::Entry.create!(user: other_user, kind: "reference", scope: "repository",
    ...
    it "does not read deleted owned memories" do
      memory = AgentMemory::Entry.create!(user: chat_user, kind: "feedback", scope: "global", content: "Old.")
