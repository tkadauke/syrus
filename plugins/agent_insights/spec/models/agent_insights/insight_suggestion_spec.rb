...
RSpec.describe AgentInsights::Suggestion do
  ...
  describe "state transitions" do
    ...
    describe "#retire!" do
      ...
      it "returns false and does not retire when already retired" do
        ...
        }.not_to change(AgentInsights::AuditEvent, :count)
      end
  ...
  describe "scopes" do
    it ".for_repository scopes to the given repository" do
      ...
      expect(AgentInsights::Suggestion.for_repository(repository).count).to eq(1)
    end
    ...
    it ".pending only returns pending suggestions" do
      ...
      expect(AgentInsights::Suggestion.pending).to include(s1)
      expect(AgentInsights::Suggestion.pending).not_to include(s2)
    end
    ...
    it ".retired only returns retired suggestions" do
      ...
      expect(AgentInsights::Suggestion.retired).to include(s2)
      expect(AgentInsights::Suggestion.retired).not_to include(s1)
    end
    ...
    it ".active excludes retired suggestions" do
      ...
      expect(AgentInsights::Suggestion.active).to include(s1)
      expect(AgentInsights::Suggestion.active).not_to include(s2)
    end
  end
end
