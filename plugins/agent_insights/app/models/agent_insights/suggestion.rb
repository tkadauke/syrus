module AgentInsights
  class Suggestion < ApplicationRecord
    self.table_name = "agent_insight_suggestions"
    ...
    has_many :audit_events, class_name: "AgentInsights::AuditEvent", foreign_key: :insight_suggestion_id, inverse_of: :insight_suggestion, dependent: :destroy
