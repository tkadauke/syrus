module AgentInsights
  module Proposals
    class Base
      TYPES = {
        "create_job" => "AgentInsights::Proposals::CreateJob",
        "save_memory" => "AgentInsights::Proposals::SaveMemory",
        "remove_memory" => "AgentInsights::Proposals::RemoveMemory",
        "revise_existing_insight" => "AgentInsights::Proposals::Informational",
        "informational" => "AgentInsights::Proposals::Informational"
      }.freeze
