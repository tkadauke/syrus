module MetricsDashboard
  ...
  class DashboardPayload
    ...
    PANELS = [
      ...
      { key: "github_app_rate_limit_percent", metric: "syrus_github_app_rate_limit_remaining_percent",
        group_by: nil, mode: :value, aggregate: :max, unit: "percent", category: CATEGORY_RESILIENCE_PRODUCT },
      { key: "github_app_api_blocked", metric: "syrus_github_app_api_blocked_count",
        group_by: nil, mode: :value, aggregate: :max, unit: "installations", category: CATEGORY_RESILIENCE_PRODUCT },
