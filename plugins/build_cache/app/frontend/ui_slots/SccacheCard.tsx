...
import type { JobSccacheInfo } from "../api/adminBuildCache"
import { Card } from "@app/components/Card"
import { TonePill, type PillTone } from "@app/components/StatusPill"
...
// Rendered into the job.detail ui_slot. The host passes the job payload's
// sccache summary; a Job with no capture renders nothing, which is the normal
// case for repositories that never compile anything.
export default function SccacheSlot({ sccache }: { sccache?: JobSccacheInfo | null }) {
  if (!sccache) return null

  return <SccacheCard sccache={sccache} />
}
