...
function DesignDocFormattingToolbar({ canWriteCanonical, changeMode, draft, editorMode, selection, setChangeMode, setEditorMode, onCommand }: {
  ...
  return (
    <div
      ...
      className="sticky top-0 z-20 flex min-w-0 items-center gap-2 rounded-t border-b border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-700 dark:bg-gray-950/40"
