    ...
    module App
      ...
      class RepositoryIssuesController < BaseController
        ...
        def comment_issue
          ...
          render json: repository_issues_payload(repository, folder: issue_folder, filter: issue_filter, sort: issue_sort, message: I18n.t("api.repositories.comment_added", number: issue_number))
