...
// payload they're looking at. A "Create Job" shortcut skips the chat
// round-trip entirely and lands the same bundle directly as a direct Job.
...
export function ToolCardDiscussButton({ deepLink, entry, example, previewRef, viewportPresetId }: ToolCardDiscussButtonProps) {
  ...
  return (
    <CatalogFeedbackDialog
      ...
      createJob={{
        onCreateJob: (input) => createToolCardJob(input),
        button: t("tool_cards.discuss.create_job"),
        creating: t("tool_cards.discuss.creating_job"),
        requiresPrompt: t("tool_cards.discuss.create_job_requires_prompt"),
        failed: t("tool_cards.discuss.job_failed")
      }}
