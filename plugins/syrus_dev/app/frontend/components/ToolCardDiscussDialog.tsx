...
export function ToolCardDiscussButton({ deepLink, entry, example, previewRef, viewportPresetId }: ToolCardDiscussButtonProps) {
  ...
  return (
    <CatalogFeedbackDialog
      ...
      createJob={(input) => createToolCardJob({ prompt: input.prompt, screenshot: input.screenshot })}
      copy={{
        ...
        jobFailed: t("tool_cards.discuss.job_failed"),
        createJob: t("tool_cards.discuss.create_job"),
        creatingJob: t("tool_cards.discuss.creating_job"),
        createJobRequiresPrompt: t("tool_cards.discuss.create_job_requires_prompt")
      }}
