...
import { fetchRepositorySkills, type SkillSummary } from "@app/api/skills"
import { initialArgs, SkillOption, SkillParameterInput } from "@app/routes/RepositorySkillNew"
...
export function ScheduledTaskFormRoute({ mode }: { mode: "new" | "edit" }) {
  ...
  return (
    <Page.Root aria-label={mode === "new" ? t("scheduled_tasks.new_heading") : t("scheduled_tasks.edit_heading")} className="max-w-3xl" gutter="responsive">
