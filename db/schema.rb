...
ActiveRecord::Schema[8.1].define(version: 2026_09_09_123000) do
  ...
  create_table "workflow_source_snapshots", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "creator_step_id", null: false
    ...
    t.index ["workflow_id", "published_at", "id"], name: "idx_workflow_source_snapshots_current"
    t.index ["workflow_id", "source_sha"], name: "idx_workflow_source_snapshots_workflow_sha", unique: true
    t.index ["workflow_id"], name: "index_workflow_source_snapshots_on_workflow_id"
  end
