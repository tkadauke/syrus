...
ActiveRecord::Schema[8.1].define(version: 2026_09_25_062000) do
  ...
  create_table "build_cache_clear_requests", force: :cascade do |t|
  ...
  create_table "chat_sessions", force: :cascade do |t|
    ...
    t.string "workspace_storage_key"
  ...
  create_table "metrics_dashboard_samples", force: :cascade do |t|
    t.json "labels"
    t.string "metric", limit: 190, null: false
    t.datetime "recorded_at", null: false
    t.string "series_key", limit: 190, null: false
    t.float "value", null: false
    t.index ["metric", "series_key", "recorded_at"], name: "idx_metrics_dashboard_series_minute", unique: true
    t.index ["recorded_at"], name: "index_metrics_dashboard_samples_on_recorded_at"
  end
  ...
  create_table "repositories", force: :cascade do |t|
    ...
    t.datetime "last_main_health_poll_error_at"
    ...
    t.boolean "main_branch_repair_blocks_work", default: true, null: false
  ...
  create_table "runs", force: :cascade do |t|
    ...
    t.index ["step_id", "state", "created_at", "id"], name: "idx_runs_step_state_created_latest"
  ...
  create_table "terminal_sessions", force: :cascade do |t|
    ...
    t.string "workspace_kind"
    t.index ["chat_session_id"], name: "index_terminal_sessions_on_chat_session_id"
    t.index ["finished_at"], name: "index_terminal_sessions_on_finished_at"
    t.index ["queue_name"], name: "index_terminal_sessions_on_queue_name"
    t.index ["user_id"], name: "index_terminal_sessions_on_user_id"
    t.index ["worker_storage_key"], name: "index_terminal_sessions_on_worker_storage_key"
  ...
  create_table "work_intents", force: :cascade do |t|
    ...
    t.index ["kind", "requested_at", "id"], name: "idx_work_intents_admin_kind"
    t.index ["kind", "state", "repository_id"], name: "idx_work_intents_kind_state_repo"
    t.index ["repository_id", "requested_at", "id"], name: "idx_work_intents_admin_repository"
    t.index ["repository_id", "scope_type", "state", "scope_id"], name: "idx_work_intents_repo_scope_state_scope_id"
    t.index ["requested_at", "id"], name: "idx_work_intents_admin_requested"
    t.index ["scope_type", "scope_id", "requested_at", "id"], name: "idx_work_intents_admin_scope"
    t.index ["scope_type", "scope_id", "state"], name: "idx_work_intents_scope_state"
    t.index ["state", "requested_at", "id"], name: "idx_work_intents_admin_state"
  ...
  create_table "workflows", force: :cascade do |t|
    ...
    t.index ["worker_hostname", "state", "id"], name: "idx_workflows_worker_hostname_state_id"
