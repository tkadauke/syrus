...
ActiveRecord::Schema[8.1].define(version: 2026_09_03_100000) do
  ...
  add_foreign_key "diff_review_comments", "jobs"
  add_foreign_key "diff_review_comments", "runs"
  add_foreign_key "diff_review_comments", "users"
  add_foreign_key "diff_review_comments", "workflows"
end
