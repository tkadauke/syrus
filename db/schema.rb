...
ActiveRecord::Schema[8.1].define(version: 2026_09_18_154332) do
  ...
  create_table "worker_host_health_samples", force: :cascade do |t|
    ...
    t.index ["worker_storage_key", "role", "observed_at"], name: "idx_worker_health_storage_key_role_observed"
  end
