class RepairStaleParsedPendingDependenciesOnNonIssueJobs < ActiveRecord::Migration[8.1]
  def up
    say_with_time "Repairing stale parsed pending dependencies on non-issue Jobs" do
