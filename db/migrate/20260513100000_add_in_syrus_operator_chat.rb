class AddInSyrusOperatorChat < ActiveRecord::Migration[8.1]
  def change
    ...
    create_table :operator_questions do |t|
      t.references :job, null: false, foreign_key: true, type: :integer
      t.references :workflow, null: false, foreign_key: true, type: :integer
      t.references :run, null: false, foreign_key: true, type: :integer
    ...
    create_table :operator_responses do |t|
      t.references :operator_question, null: false, foreign_key: true, type: :integer
      t.text :text, null: false
