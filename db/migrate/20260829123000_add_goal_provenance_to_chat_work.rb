class AddGoalProvenanceToChatWork < ActiveRecord::Migration[8.1]
  def change
    add_column :chat_proposals, :chat_goal_id, :bigint unless column_exists?(:chat_proposals, :chat_goal_id)
    ...
    add_column :jobs, :chat_goal_id, :bigint unless column_exists?(:jobs, :chat_goal_id)
    ...
    add_column :epics, :chat_goal_id, :bigint unless column_exists?(:epics, :chat_goal_id)
