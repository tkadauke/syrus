class AddUnresolvedProposalToJobDependencies < ActiveRecord::Migration[8.1]
  def up
    add_reference :job_dependencies,
                  ...
                  null: true,
                  foreign_key: { to_table: :chat_proposals } unless column_exists?(:job_dependencies, :unresolved_chat_proposal_id)
    ...
    add_index :job_dependencies,
              ...
              name: "index_job_deps_on_unresolved_proposal_per_job" unless index_exists?(:job_dependencies, [ :job_id, :unresolved_chat_proposal_id ], name: "index_job_deps_on_unresolved_proposal_per_job")
  end
